(function (global) {
    ...
    const icons = {
        ...
        uturn_right: `${circle}<path d="M36 68 V45 A14 14 0 0 1 64 45 V68" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/><path d="M55 59 L64 68 L73 59" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/>`
    };
